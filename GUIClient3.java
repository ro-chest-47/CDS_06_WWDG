...
public class GUIClient3 extends JFrame {
	...
	private GUIClientEventHandler3 m_eventHandler;
...
//	private String playerAndScore;
	...
	private Timer timer;
	private TimerCountdown3 timerCountdown;
...
//		northPanel.add(northRight(), BorderLayout.EAST);
		...
		m_eventHandler = new GUIClientEventHandler3(m_clientStub, this);
...
//		allPlayerCard = new int[] {0, 0, 0, 0, 0};
		...
		timer = new Timer();
		timerCountdown = new TimerCountdown3(this);
	...
	public GUIClientEventHandler3 getClientEventHandler() {
...
//		p.setSize((int) 30, 80);
	...
	*/
	...
	// add Client
	public void addExitEvent(GUIClient3 client, CMClientStub cmstub) {
