...
public class CMSessionInfo {
	...
	// for our project
	protected int m_nPossibleGroups;
	// for our project
	...
	// for our project
	public CMSessionInfo(String sname, String address, int port, int nUserNum, int nPossibleGroups) {
		m_strSessionName = sname;
		m_strAddress = address;
		m_nPort = port;
		m_nUserNum = nUserNum;
		m_nPossibleGroups = nPossibleGroups;
	}
	// for our project
	...
	// for our project
	public synchronized void setPossibleGroups(int groups) {
		m_nPossibleGroups = groups;
	}

	public synchronized int getPossibleGroups() {
		return m_nPossibleGroups; 
	}
	// for our project
}
