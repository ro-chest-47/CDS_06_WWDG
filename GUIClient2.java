...
public class GUIClient2 extends JFrame {
	...
	private GUIClientEventHandler2 m_eventHandler;
...
//	private String playerAndScore;
	...
	private Timer timer;
	private TimerCountdown2 timerCountdown;
...
//		northPanel.add(northRight(), BorderLayout.EAST);
		...
		m_eventHandler = new GUIClientEventHandler2(m_clientStub, this);
...
//		allPlayerCard = new int[] {0, 0, 0, 0, 0};
		...
		timer = new Timer();
		timerCountdown = new TimerCountdown2(this);
	...
	public GUIClientEventHandler2 getClientEventHandler() {
...
//		p.setSize((int) 30, 80);
	...
	*/
	...
	// add Client
	public void addExitEvent(GUIClient2 client, CMClientStub cmstub) {
