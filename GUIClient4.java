...
public class GUIClient4 extends JFrame {
	...
	private GUIClientEventHandler4 m_eventHandler;
...
//	private String playerAndScore;
	...
	private Timer timer;
	private TimerCountdown4 timerCountdown;
...
//		northPanel.add(northRight(), BorderLayout.EAST);
		...
		m_eventHandler = new GUIClientEventHandler4(m_clientStub, this);
...
//		allPlayerCard = new int[] {0, 0, 0, 0, 0};
		...
		timer = new Timer();
		timerCountdown = new TimerCountdown4(this);
	...
	public GUIClientEventHandler4 getClientEventHandler() {
...
//		p.setSize((int) 30, 80);
	...
	*/
	...
	// add Client
	public void addExitEvent(GUIClient4 client, CMClientStub cmstub) {
